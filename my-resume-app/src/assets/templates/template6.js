...
// SECTION RENDERER — universal
const renderSection = (section, data, sectionTitles) => {
  switch (section) {
    case "Profile":
      return (
        <>
...
const Template6 = ({
  ...
  return (
    <div className="t6-wrapper" style={pageStyle}>
      {/* HEADER */}
      <header className="t6-header">
        <h1 className="t6-name">{data.fullName}</h1>
        <p className="t6-role">{data.headline}</p>
      ...
      <div className="t6-columns">
        {/* LEFT COLUMN */}
        <aside className="t6-left">
          {layout.left.map((sectionName) => (
            <div key={sectionName} className="t6-section-block">

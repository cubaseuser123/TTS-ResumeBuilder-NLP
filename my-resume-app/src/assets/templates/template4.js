...
const renderSection = (sectionName, data, sectionTitles) => {
  switch (sectionName) {
    case "Profile":
      return (
        <>
          <h3 className="t4-section-title" data-section-title>
      ...
      return (
        <>
          ...
          {data.skills.map((skill, i) => (
            <div key={i} className="t4-language-item">
              <div>
...
const Template4 = ({
  ...
  return (
    <div className="t4-wrapper" style={pageStyle}>
      {/* HEADER */}
      <header className="t4-header">
        <h1 className="t4-name">{data.fullName}</h1>
        <p className="t4-role">{data.headline}</p>

        <div className="t4-contact-row">
